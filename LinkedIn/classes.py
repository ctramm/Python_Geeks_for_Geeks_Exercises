"""
https://www.linkedin.com/learning/test-automation-with-python-2-python-for-testers/classes?autoSkip=true&autoplay=true&resume=false&u=95141346
"""
...
class Vehicle:
    ...
    def __repr__(self):
        return (
            f"{self.make} {self.model} with engine "
    ...
    def turn_engine_off(self):
        ...
        if self.is_driving:
            print(
                "You tried to turn the engine off while driving, "
                "and crashed."
            )
            return
    ...
    def start_driving(self):
        if not self.is_engine_on:
            print("You can't drive without the turning the engine on!")
            return
